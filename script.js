...
const displayAverageSalary = function (employeesArray) {
  ...
  let avSalary = av / numEmployees;
  avSalary = avSalary.toFixed(2);
  console.log(avSalary);

  window.alert(`Your average employee salary is $${avSalary}`);
};
...
const getRandomEmployee = function (employeesArray) {
  ...
  window.alert(
    `Congrats to ${randomEmployee.firstName} ${randomEmployee.lastName}, our random draw winner!`
  );
};
